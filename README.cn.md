...
[![x-cmd/install — lazygit Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/lazygit.svg?lang=zh)](https://x-cmd.com/install/lazygit)
...
合计: **461,856** 行代码（覆盖前 5 种语言、共 **2047** 个文件）。
...
- **上游仓库**: <https://github.com/jesseduffield/lazygit>
- **许可证**: MIT
...
- **Star**: 82,656 · **Fork**: 3,047 · **开放 issue**: 2,726 · **贡献者**: 359

## 累计统计

- **发布数**: 188 · **已合并 PR**: 2072 · **开放 PR**: 191 · **已关闭 issue**: 1863 · **开放 issue**: 863 · **提交数**: 8286

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 2 | 21 | 31 | 9 | 12 | 74 |
| last60d | 2026-07-27 | 4 | 62 | 36 | 25 | 28 | 225 |
| 90d | 2026-06-27 | 6 | 123 | 53 | 36 | 53 | 499 |
| last180d | 2026-03-29 | 11 | 228 | 83 | 78 | 100 | 766 |
| 360d | 2025-09-30 | 17 | 357 | 134 | 191 | 210 | 1021 |
| last720d | 2024-10-05 | 34 | 671 | 162 | 416 | 360 | 2462 |
...
lazygit 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `lazygit` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/lazygit.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T05:41:40Z._
